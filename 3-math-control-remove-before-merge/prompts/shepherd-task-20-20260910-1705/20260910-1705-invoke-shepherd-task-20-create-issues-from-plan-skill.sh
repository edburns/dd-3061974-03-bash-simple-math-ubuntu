#!/usr/bin/env bash
set -euo pipefail
timestamp=20260910-1705
log_dir_full=/home/edburns/workareas/dd-3061974-03-bash-simple-math-ubuntu-shepherd-control/3-math-control-remove-before-merge/prompts/shepherd-task-20-20260910-1705
...
prompt_file=/home/edburns/workareas/dd-3061974-03-bash-simple-math-ubuntu-shepherd-control/3-math-control-remove-before-merge/prompts/shepherd-task-20-20260910-1705/20260910-1705-invoke-shepherd-task-20-create-issues-from-plan-skill.md
